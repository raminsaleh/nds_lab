# NDS Hook Geometry v1

## Purpose

Hook is a structured geometric component, not a simple pullback. NDS identifies Hook Type A and Hook Type B in positive and negative cycles.

## Core Rules

Hook validation requires type, polarity, 123 structure, X-axis geometry, Y-axis geometry, symmetry, flag context, ND context, 86% context, and higher-timeframe context.
