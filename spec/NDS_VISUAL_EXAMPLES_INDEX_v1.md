# NDS Visual Examples Index v1

## Purpose

Indexes chart-based and schematic evidence for later manual validation, template extraction, and implementation design.

## Core Rules

Visual examples include Bitcoin cycle analysis, 123 Flag Hook, 86% examples, Hook A/B diagrams, Rally 123, Point 3 decision, and Persian Academy diagrams. Do not extract final code rules from OCR alone.
