...
Flag is a geometric/polynomial NDS structure involved in continuation, reversal preparation, node validation, hook formation, and cycle progression.

## Core Rules

Observed components: SMI/BMI, Z, LVS, F. Exact formal definitions require validation. Point 3 rejected -> ND candidate. Point 3 broken -> Flag continuation toward F. Flag is not generic consolidation.
