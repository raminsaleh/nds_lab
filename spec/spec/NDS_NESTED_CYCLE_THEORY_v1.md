# NDS Nested Cycle Theory v1

## Purpose

Lower-timeframe cycles exist inside higher-timeframe cycles. Nodes may be displaced by parent timeframe pressure.

## Core Rules

Each node should store raw and adjusted positions. Higher-timeframe pressure may be derivative-based. Local structures conflicting with parent pressure should be downgraded or rejected.
