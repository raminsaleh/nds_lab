# NDS 123 Structures v1

## Purpose

123 is multi-context: hook closure, fractal leg construction, rally geometry, flag termination, point 3 decision, ND setup, and cycle completion.

## Core Rules

Context classification is mandatory before applying any 123 rule. Point 3 rejected -> ND; point 3 broken -> Flag continuation. Symmetry, timeframe context, and 86% context must be checked.
