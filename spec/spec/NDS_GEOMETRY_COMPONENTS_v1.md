# NDS Geometry Components v1

## Purpose

Architecture map for Cycle, Node, Trend/Rally, Pullback, Flag, Hook, 123, ND, 86%, Symmetry, and Fractal Context.

## Core Rules

NDS Geometry = Cycle + Node + Flag + Hook + Rally + 123 + ND + 86% + Symmetry + Fractal Context. No component alone is a complete NDS signal.
