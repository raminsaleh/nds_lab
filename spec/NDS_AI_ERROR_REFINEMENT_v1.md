# NDS AI Error Refinement v1

## Purpose

AI is not the NDS model. AI is an error-refinement layer over source-defined NDS structures.

## Core Rules

Valid: NDS structure detection -> trend/pullback fitting -> residuals -> RF/NN correction -> validation. Invalid: raw OHLC -> AI -> direct buy/sell.
