# NDS Sequence Execution v1

## Purpose

NDS must use a sequence-aware state machine. Canonical sequence: Z -> N1 -> S1 -> N2 -> S2 -> N3 -> S3.

## Core Rules

Invalid jumps must be rejected. N3 is trend completion; S3 is cycle completion. Point 3 rejected routes to ND; point 3 broken routes to Flag continuation. Risk approval is required before trade execution.
